    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    channelWrapper = _a.sent();
                    console.log("Before sending");
                    return [4 /*yield*/, channelWrapper.sendToQueue(queuename, message)];
                case 2:
                    _a.sent();
